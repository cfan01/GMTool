...
2.遊戲主題(game subject)
3.VIP篩選(一般,白鑽,藍鑽,金鑽,紅鑽)

query items:
遊戲主題在00:00 ~ 23:45之間(每隔15分鐘)的同時在線人數

refer to: http://1fkia7.axshare.com/#g=1&p=4_4_5、歷史在線
...
******************/
app.findHistoryOnline = function(query, cb){
...
//  });
    ...
    cb(data.HistoryOnline_Info); //For Test ONLY! MUST remove if modify
}
