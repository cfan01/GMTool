...
function moveSelectedOptions(fromID,toID) {
	...
	if (arguments.length>3) {
		...
		//if (regex == '*') { alert("The selected item(s) CANNOT be moved."); return; }
		if (regex != "") {
	...
	// Move them over
	if (!hasOptions(from)) { /*alert('qqqqqqqq');*/ return; }
...
// -------------------------------------------------------------------
function copySelectedOptions(fromID,toID) {
	var from = document.getElementById(fromID);
	var to = document.getElementById(toID);
...
function swapOptions(obj,i,j) {
	...
	if(o[i].text.indexOf('*') > -1) {
		o[i].style.color = "red";
	}
	if(o[j].text.indexOf('*') > -1) {
		o[j].style.color = "red";
	}
}
...
// -------------------------------------------------------------------
// moveOptionTop(select_object)
//  Move selected option in a select list up one
// -------------------------------------------------------------------
function moveOptionTop(objID) {
	//alert('moveOptionTop');
	var obj = document.getElementById(objID);
	if (!hasOptions(obj)) { return; }
	$('#'+objID+' option:selected').insertBefore('#'+objID+' option:first-child')
}

// -------------------------------------------------------------------
// moveOptionBottom(select_object)
//  Move selected option in a select list up one
// -------------------------------------------------------------------
function moveOptionBottom(objID) {
	//alert('moveOptionBottom');
	var obj = document.getElementById(objID);
	if (!hasOptions(obj)) { return; }
	$('#'+objID+' option:selected').insertAfter('#'+objID+' option:last-child')
}
...
// -------------------------------------------------------------------
function removeSelectedOptions(fromID) { 
	var from = document.getElementById(fromID);
	if (!hasOptions(from)) { return; }
...
// -------------------------------------------------------------------
function removeAllOptions(fromID) {
	var from = document.getElementById(fromID);
	if (!hasOptions(from)) { return; }
	for (var i=(from.options.length-1); i>=0; i--) { 
		from.options[i] = null; 
