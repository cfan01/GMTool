...
function queryResult()
{
  ...
  $.getJSON('/js/game.json', function(data) {
    ...
    //s+="     更新時間：&nbsp;<span id=\"sec\">00:00:33&nbsp;之前</span>";
    //s+="     <a class=\"waves-light btn blue\" id=\"cancel\" onclick=\"location.href='/game/jp_monitor'\">擷取最新</a>";
    s+="       <div style=\"width:85%;float:left\">";
    s+="         更新時間：&nbsp;&nbsp;<span id='sec'></span>&nbsp;&nbsp;";
    s+="       </div>";
    s+="       <div style=\"width:10%;float:left\">";
    s+="         <a href=\"#\" class=\"wrapper\" onclick=\"location.href='/game/jp_monitor'\"><span class=\"t4\">擷取最新</span><img id='img2' src='/images/button_6blue.png'></a>";
    s+="       </div>";
    s+="  </div>";
    s+="</div>";
    s+="<ul class=\"collapsible\" data-collapsible=\"expandable\">";
    ...
    s+="        <tr>";
    s+="           <td style=\"width:25%;text-align:right;\">累積投注額：</td>";
    s+="           <td style=\"width:20%;text-align:left;\">"+accounting.formatMoney(data.JP_Monitor_Info.Latest_News.cumulative_bets,"",0)+"</td>";
    s+="           <td>&nbsp;</td>";
    s+="           <td>&nbsp;</td>";
    s+="        </tr>";
    s+="        <tr>";
    s+="           <td style=\"width:25%;text-align:right;\">JP總累積得分：</td>";
    s+="           <td style=\"width:20%;text-align:left;\">"+accounting.formatMoney(data.JP_Monitor_Info.Latest_News.total_cumulative_score,"",0)+"</td>";
    s+="           <td>&nbsp;</td>";
    s+="           <td>&nbsp;</td>";
    s+="        </tr>";
    s+="        <tr>";
    s+="           <td style=\"width:25%;text-align:right;\">實際抽取%：</td>";
    s+="           <td style=\"width:20%;text-align:left;\">"+accounting.formatMoney(data.JP_Monitor_Info.Latest_News.real_extraction,"",2)+"%</td>";
    s+="           <td>&nbsp;</td>";
    s+="           <td>&nbsp;</td>";
    s+="        </tr>";
    s+="      </table>";
    ...
    s+="           	 	   <tr>";
    s+="           	 	   	 <td style=\"text-align:center;width:20%\">Grand(JP1)</td>";
    s+="           	 	   	 <td style=\"text-align:center;width:20%\">"+accounting.formatMoney(data.JP_Monitor_Info.Latest_News.jp_threshold_show.JP1.cumulative_numofwins,"",0)+"</td>";
    s+="           	 	   	 <td style=\"text-align:center;width:20%\">"+accounting.formatMoney(data.JP_Monitor_Info.Latest_News.jp_threshold_show.JP1.cumulative_score,"",0)+"</td>";
    s+="           	 	   	 <td style=\"text-align:center;width:20%\">"+accounting.formatMoney(data.JP_Monitor_Info.Latest_News.jp_threshold_show.JP1.current_score,"",0)+"</td>";
    s+="           	 	   	 <td id=\"td_jp_threshold_0\" style=\"text-align:center;width:20%;display:none;\">"+accounting.formatMoney(data.JP_Monitor_Info.Latest_News.jp_threshold_show.JP1.jp_threshold,"",0)+"</td>";
    s+="                 </tr>";
    s+="           	 	   <tr>";
    s+="           	 	   	 <td style=\"text-align:center;width:20%\">Major(JP2)</td>";
    s+="           	 	   	 <td style=\"text-align:center;width:20%\">"+accounting.formatMoney(data.JP_Monitor_Info.Latest_News.jp_threshold_show.JP2.cumulative_numofwins,"",0)+"</td>";
    s+="           	 	   	 <td style=\"text-align:center;width:20%\">"+accounting.formatMoney(data.JP_Monitor_Info.Latest_News.jp_threshold_show.JP2.cumulative_score,"",0)+"</td>";
    s+="           	 	   	 <td style=\"text-align:center;width:20%\">"+accounting.formatMoney(data.JP_Monitor_Info.Latest_News.jp_threshold_show.JP2.current_score,"",0)+"</td>";
    s+="           	 	   	 <td id=\"td_jp_threshold_1\" style=\"text-align:center;width:20%;display:none;\">"+accounting.formatMoney(data.JP_Monitor_Info.Latest_News.jp_threshold_show.JP2.jp_threshold,"",0)+"</td>";
    s+="                 </tr>";
    s+="           	 	   <tr>";
    s+="           	 	   	 <td style=\"text-align:center;width:20%\">Minor(JP3)</td>";
    s+="           	 	   	 <td style=\"text-align:center;width:20%\">"+accounting.formatMoney(data.JP_Monitor_Info.Latest_News.jp_threshold_show.JP3.cumulative_numofwins,"",0)+"</td>";
    s+="           	 	   	 <td style=\"text-align:center;width:20%\">"+accounting.formatMoney(data.JP_Monitor_Info.Latest_News.jp_threshold_show.JP3.cumulative_score,"",0)+"</td>";
    s+="           	 	   	 <td style=\"text-align:center;width:20%\">"+accounting.formatMoney(data.JP_Monitor_Info.Latest_News.jp_threshold_show.JP3.current_score,"",0)+"</td>";
    s+="           	 	   	 <td id=\"td_jp_threshold_2\" style=\"text-align:center;width:20%;display:none;\">"+accounting.formatMoney(data.JP_Monitor_Info.Latest_News.jp_threshold_show.JP3.jp_threshold,"",0)+"</td>";
    s+="                 </tr>";
    s+="           	 	   <tr>";
    s+="           	 	   	 <td style=\"text-align:center;width:20%\">Mini(JP4)</td>";
    s+="           	 	   	 <td style=\"text-align:center;width:20%\">"+accounting.formatMoney(data.JP_Monitor_Info.Latest_News.jp_threshold_show.JP4.cumulative_numofwins,"",0)+"</td>";
    s+="           	 	   	 <td style=\"text-align:center;width:20%\">"+accounting.formatMoney(data.JP_Monitor_Info.Latest_News.jp_threshold_show.JP4.cumulative_score,"",0)+"</td>";
    s+="           	 	   	 <td style=\"text-align:center;width:20%\">"+accounting.formatMoney(data.JP_Monitor_Info.Latest_News.jp_threshold_show.JP4.current_score,"",0)+"</td>";
    s+="           	 	   	 <td id=\"td_jp_threshold_3\" style=\"text-align:center;width:20%;display:none;\">"+accounting.formatMoney(data.JP_Monitor_Info.Latest_News.jp_threshold_show.JP4.jp_threshold,"",0)+"</td>";
    s+="                 </tr>";
    s+="               </tbody>";
    s+="             </table>";
    s+="           </td>";
    ...
    s+="          	<div id=\"game_subject_lists\" style=\"float:left;width:100%;\">";
              $.each(data.Game_Subjects, function(i,v) {
                 ...
                 for(var j=0;j<data.JP_Monitor_Info.JP_Settings.common_game_lists.length;j++)
                 {
                   //alert('1 = '+v[Object.keys(v)[0]]);
                   //alert('2 = '+data.JP_Monitor_Info.JP_Settings.common_game_lists[j]);
                   //var c=(data.JP_Monitor_Info.JP_Settings.common_game_lists[j]==v[Object.keys(v)[0]])?"checked":"";
                   if(data.JP_Monitor_Info.JP_Settings.common_game_lists[j]==v[Object.keys(v)[0]])
                   {
                     c="checked";
                     break;
                   }
    ...
    s+="           	 	   <tr>";
    s+="           	 	   	 <td style=\"text-align:center;width:10%\">Grand(JP1)</td>";
    s+="           	 	   	 <td style=\"text-align:center;width:17%\"><input type=\"text\" id=\"base_set0\" name=\"base_set0\" value=\""+accounting.formatMoney(data.JP_Monitor_Info.JP_Settings.parameter_settings.JP1.base_set,"",0)+"\" width=\"5%\" style=\"text-align:center;\"></td>";
    s+="           	 	   	 <td style=\"text-align:center;width:17%\"><input type=\"text\" id=\"uplimit_set0\" name=\"uplimit_set0\" value=\""+accounting.formatMoney(data.JP_Monitor_Info.JP_Settings.parameter_settings.JP1.uplimit_set,"",0)+"\" width=\"5%\" style=\"text-align:center;\"></td>";
    s+="           	 	   	 <td style=\"text-align:center;width:17%\"><input type=\"text\" id=\"bet_retrieve_pa0\" name=\"bet_retrieve_pa0\" value=\""+accounting.formatMoney(data.JP_Monitor_Info.JP_Settings.parameter_settings.JP1.bet_retrieve_pa,"",2)+"\" style=\"text-align:center;width:50%;\">%</td>";
    s+="           	 	   	 <td style=\"text-align:center;width:17%\"><input type=\"text\" id=\"bet_threshold0\" name=\"bet_threshold0\" value=\""+accounting.formatMoney(data.JP_Monitor_Info.JP_Settings.parameter_settings.JP1.bet_threshold_pa,"",2)+"\" style=\"text-align:center;width:50%;\">%</td>";
    s+="           	 	   	 <td style=\"text-align:center;width:22%\">";
    s+="           	 	   	 	  <input type=\"radio\" id=\"jp_retrieve_yes0\" name=\"jp_retrieve1\" value=\"yes\" width=\"15%\" "+(data.JP_Monitor_Info.JP_Settings.parameter_settings.JP1.jp_retrieve1=="yes"?"checked":"")+">";
    s+="   	                  <label for=\"jp_retrieve_yes0\">可拉(預設)</label>&nbsp;&nbsp;&nbsp;";
    s+="                      <input type=\"radio\" id=\"jp_retrieve_no0\" name=\"jp_retrieve1\" value=\"no\" width=\"15%\" "+(data.JP_Monitor_Info.JP_Settings.parameter_settings.JP1.jp_retrieve1=="no"?"checked":"")+">";
    ...
    s+="           	 	   <tr>";
    s+="           	 	   	 <td style=\"text-align:center;\">Major(JP2)</td>";
    s+="           	 	   	 <td style=\"text-align:center;\"><input type=\"text\" id=\"base_set1\" name=\"base_set1\" value=\""+accounting.formatMoney(data.JP_Monitor_Info.JP_Settings.parameter_settings.JP2.base_set,"",0)+"\" width=\"5%\" style=\"text-align:center;\"></td>";
    s+="           	 	   	 <td style=\"text-align:center;\"><input type=\"text\" id=\"uplimit_set1\" name=\"uplimit_set1\" value=\""+accounting.formatMoney(data.JP_Monitor_Info.JP_Settings.parameter_settings.JP2.uplimit_set,"",0)+"\" width=\"5%\" style=\"text-align:center;\"></td>";
    s+="           	 	   	 <td style=\"text-align:center;\"><input type=\"text\" id=\"bet_retrieve_pa1\" name=\"bet_retrieve_pa1\" value=\""+accounting.formatMoney(data.JP_Monitor_Info.JP_Settings.parameter_settings.JP2.bet_retrieve_pa,"",2)+"\" style=\"text-align:center;width:50%;\">%</td>";
    s+="           	 	   	 <td style=\"text-align:center;\"><input type=\"text\" id=\"bet_threshold1\" name=\"bet_threshold1\" value=\""+accounting.formatMoney(data.JP_Monitor_Info.JP_Settings.parameter_settings.JP2.bet_threshold_pa,"",2)+"\" style=\"text-align:center;width:50%;\">%</td>";
    s+="           	 	   	 <td style=\"text-align:center;\">";
    s+="           	 	   	 	  <input type=\"radio\" id=\"jp_retrieve_yes1\" name=\"jp_retrieve2\" value=\"yes\" "+(data.JP_Monitor_Info.JP_Settings.parameter_settings.JP2.jp_retrieve2=="yes"?"checked":"")+">";
    s+="   	                  <label for=\"jp_retrieve_yes1\">可拉(預設)</label>&nbsp;&nbsp;&nbsp;";
    s+="                      <input type=\"radio\" id=\"jp_retrieve_no1\" name=\"jp_retrieve2\" value=\"no\" "+(data.JP_Monitor_Info.JP_Settings.parameter_settings.JP2.jp_retrieve2=="no"?"checked":"")+">";
    ...
    s+="           	 	   <tr>";
    s+="           	 	   	 <td style=\"text-align:center;\">Minor(JP3)</td>";
    s+="           	 	   	 <td style=\"text-align:center;\"><input type=\"text\" id=\"base_set2\" name=\"base_set2\" value=\""+accounting.formatMoney(data.JP_Monitor_Info.JP_Settings.parameter_settings.JP3.base_set,"",0)+"\" width=\"5%\" style=\"text-align:center;\"></td>";
    s+="           	 	   	 <td style=\"text-align:center;\"><input type=\"text\" id=\"uplimit_set2\" name=\"uplimit_set2\" value=\""+accounting.formatMoney(data.JP_Monitor_Info.JP_Settings.parameter_settings.JP3.uplimit_set,"",0)+"\" width=\"5%\" style=\"text-align:center;\"></td>";
    s+="           	 	   	 <td style=\"text-align:center;\"><input type=\"text\" id=\"bet_retrieve_pa\" name=\"bet_retrieve_pa2\" value=\""+accounting.formatMoney(data.JP_Monitor_Info.JP_Settings.parameter_settings.JP3.bet_retrieve_pa,"",2)+"\" style=\"text-align:center;width:50%;\">%</td>";
    s+="           	 	   	 <td style=\"text-align:center;\"><input type=\"text\" id=\"bet_threshold2\" name=\"bet_threshold2\" value=\""+accounting.formatMoney(data.JP_Monitor_Info.JP_Settings.parameter_settings.JP3.bet_threshold_pa,"",2)+"\" style=\"text-align:center;width:50%;\">%</td>";
    s+="           	 	   	 <td style=\"text-align:center;\">";
    s+="           	 	   	 	  <input type=\"radio\" id=\"jp_retrieve_yes2\" name=\"jp_retrieve3\" value=\"yes\" "+(data.JP_Monitor_Info.JP_Settings.parameter_settings.JP3.jp_retrieve3=="yes"?"checked":"")+">";
    s+="   	                  <label for=\"jp_retrieve_yes2\">可拉(預設)</label>&nbsp;&nbsp;&nbsp;";
    s+="                      <input type=\"radio\" id=\"jp_retrieve_no2\" name=\"jp_retrieve3\" value=\"no\" "+(data.JP_Monitor_Info.JP_Settings.parameter_settings.JP3.jp_retrieve3=="no"?"checked":"")+">";
    ...
    s+="           	 	   <tr>";
    s+="           	 	   	 <td style=\"text-align:center;\">Mini(JP4)</td>";
    s+="           	 	   	 <td style=\"text-align:center;\"><input type=\"text\" id=\"base_set3\" name=\"base_set3\" value=\""+accounting.formatMoney(data.JP_Monitor_Info.JP_Settings.parameter_settings.JP4.base_set,"",0)+"\" width=\"5%\" style=\"text-align:center;\"></td>";
    s+="           	 	   	 <td style=\"text-align:center;\"><input type=\"text\" id=\"uplimit_set3\" name=\"uplimit_set3\" value=\""+accounting.formatMoney(data.JP_Monitor_Info.JP_Settings.parameter_settings.JP4.uplimit_set,"",0)+"\" width=\"5%\" style=\"text-align:center;\"></td>";
    s+="           	 	   	 <td style=\"text-align:center;\"><input type=\"text\" id=\"bet_retrieve_pa3\" name=\"bet_retrieve_pa3\" value=\""+accounting.formatMoney(data.JP_Monitor_Info.JP_Settings.parameter_settings.JP4.bet_retrieve_pa,"",2)+"\" style=\"text-align:center;width:50%;\">%</td>";
    s+="           	 	   	 <td style=\"text-align:center;\"><input type=\"text\" id=\"bet_threshold3\" name=\"bet_threshold3\" value=\""+accounting.formatMoney(data.JP_Monitor_Info.JP_Settings.parameter_settings.JP4.bet_threshold_pa,"",2)+"\" style=\"text-align:center;width:50%;\">%</td>";
    s+="           	 	   	 <td style=\"text-align:center;\">";
    s+="           	 	   	 	  <input type=\"radio\" id=\"jp_retrieve_yes3\" name=\"jp_retrieve4\" value=\"yes\" "+(data.JP_Monitor_Info.JP_Settings.parameter_settings.JP4.jp_retrieve4=="yes"?"checked":"")+">";
    s+="   	                  <label for=\"jp_retrieve_yes3\">可拉(預設)</label>&nbsp;&nbsp;&nbsp;";
    s+="                      <input type=\"radio\" id=\"jp_retrieve_no3\" name=\"jp_retrieve4\" value=\"no\" "+(data.JP_Monitor_Info.JP_Settings.parameter_settings.JP4.jp_retrieve4=="no"?"checked":"")+">";
    ...
    s+="</ul>";
    s+="<div style=\"padding:10px 45px;background-color:#ffffff;width:100%;height:60px;\">";
    s+="  <div style=\"text-align:center;\"><a id=\"save\" href=\"#\" class=\"wrapper\" onclick=\"SaveCancel(1)\"><span class=\"t4\">變更設定</span><img id='img2' src='/images/button_6blue.png'></a></div>";
    s+="</div>";
    ...
    */
    ...
    $("#jp_threshold").click(function() {
	    if($(this).is(":checked")) {
	    	$("#th_jp_threshold").show();
	    	$("#td_jp_threshold_0").show();
	    	$("#td_jp_threshold_1").show();
	    	$("#td_jp_threshold_2").show();
	    	$("#td_jp_threshold_3").show();
      } else {
	    	$("#th_jp_threshold").hide();
	    	$("#td_jp_threshold_0").hide();
	    	$("#td_jp_threshold_1").hide();
	    	$("#td_jp_threshold_2").hide();
	    	$("#td_jp_threshold_3").hide();
      }
    });
