...
*/
  ...
  dialog = $("#dialog-form").dialog({
     ...
     modal: true,
     buttons: {
       "OK": function() { SaveBasicReportForm(1);},
       "Cancel": function() {
         dialog.dialog( "close" );
       }
     }
  ...
  */
	...
	function SaveBasicReportForm(another)
	{
    ...
    if(another)  //save as another form
    {
      ...
      {
        if (LoginAccounts.property.user_reportforms[i].formname=="")
        {
        	len1=i;
        	has_null_element1 = 1;
        	break;
      ...
      {
        if (LoginAccounts.property.menuLists[j].page=="")
        {
        	len2=j;
        	has_null_element2 = 1;
        	break;
